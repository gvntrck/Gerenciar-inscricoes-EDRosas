...
- `inscricoes-pagas.php/` — explain what lives here and when agents should edit it.
- `insricoespagas.zip/` — explain what lives here and when agents should edit it.
- `novos-campos.md/` — explain what lives here and when agents should edit it.
- `readme.md/` — explain what lives here and when agents should edit it.
- `templates/` — explain what lives here and when agents should edit it.
- `uninstall.php/` — explain what lives here and when agents should edit it.
